...
const HomeTabs=()=>{
    return(
        <bottomTab.Navigator>
            <bottomTab.Screen name='HomeIcon' component={HomeStackNavigator} options={{tabBarIcon:()=><AntDesign name="home" size={24} color="black" />}}/>
            <bottomTab.Screen name='Carrito' component={BasketScreen} options={{tabBarIcon:()=><AntDesign name="shoppingcart" size={24} color="black" />}}/>
            <bottomTab.Screen name='Profile' component={BasketScreen} options={{tabBarIcon:()=><AntDesign name="profile" size={24} color="black" />}}/>
        </bottomTab.Navigator>
    )
}
const HomeStackNavigator=()=>{
    return(
        <homeStack.Navigator >
            ...
            <homeStack.Screen name="SushiList" component={SushiList}></homeStack.Screen>
